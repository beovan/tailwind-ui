    ...
    return (
        <div className="flex w-[36rem] gap-x-4 rounded-lg bg-white p-12 ">
            ...
            <div className="space-y-7 text-[#1C2B62]">
                <div >
                    <div className="font-popi text-3xl font-bold">David Grant</div>
                    <div className="mt-1">3D Artist</div>
                </div>
                ...
                <p className="text-lg">
                    David Grant has been making video games
                    for a living for more than 14 years
                    as a Designer, Producer, Creative Director,
                    and Executive Producer,
                    creating games for console, mobile,
                    PC and Facebook
                </p>
